...
class School(object):
    ...
    def show_class_course(self):
        for key in self.school_class:
            ...
            print("\33[32;1m 班级：%s\t关联课程：%s\t价格：%s\t周期：%s月\33[0m" % (
                class_obj.class_name, course_obj.course_name, course_obj.course_price, course_obj.course_time))
    ...
    def show_teacher(self):
        ...
        for key in self.school_teacher:
            ...
            for i in teacher_obj.teacher_class:
                class_list.append(i)
            print("\33[32;1m 讲师：%s\t薪资：%s\t关联班级：%s\33[0m" % (
                teacher_obj.teacher_name, teacher_obj.teacher_salary, class_list))
    ...
    def show_teacher_classinfo(self,teacher_name):
        ...
        for i in teacher_obj.teacher_class:
            ...
            print("\33[32;1m 班级：%s\t关联课程：%s\t学员：%s\33[0m" % (class_obj.class_name, class_obj.class_course.course_name, student_list))
